// Fig. 8.20: GradeBookMultiDimensional.cs
...
public class GradeBookMultiDimensional
{
   ...
   public GradeBookMultiDimensional( string name, int[ , ] gradesArray )
   {
      CourseName = name; // set CourseName to name
      grades = gradesArray; // initialize grades array
   } // end two-parameter GradeBookMultiDimensional constructor

   // display a welcome message to the GradeBookMultiDimensional user
   ...
   public void OutputBarChart()
   {
      ...
      // for each grade in GradeBookMultiDimensional, increment the appropriate frequency 
      foreach ( int grade in grades )
      {
         ++frequency[ grade / 10 ];
      } // end foreach
...
} // end class GradeBookMultiDimensional
